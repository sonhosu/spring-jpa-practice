...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception
    {
        ...
        Book book = createBook("bookName",10000,10);
        ...
        assertEquals("주문한 상품종류 수가 정확해야한다" , 1 , getOrder.getOrderItems().size());
    ...
    public void 상품초과테스트() throws Exception
    {
        // given
        Member member = createMember();
        Book item = createBook("bookName",10000,10);
    ...
    public void 주문취소() throws Exception
    {
        ...
        assertEquals("주문이 취소된 상품은 그만틈 재고가 증가",10 ,item.getStockQuantity());
